...
typedef enum {
	...
	SE_CONSOLE				// evPtr is a char*, from typing something at a non-game console
		...
		, SE_TOUCH // for touch, it will send a event that contains X coord and Y coord of touch point, and not relative position. so disable SE_MOUSE event.
#endif
} sysEventType_t;
...
#ifdef _HARMATTAN_PLUS
	virtual sysEvent_t		GenerateMouseTouchEvent( int x, int y ) = 0;
#endif
