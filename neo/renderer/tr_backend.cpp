...
void RB_SetGL2D(void)
{
	...
	esOrtho((ESMatrix *)projectionMatrix, 0, 480, 640, 0, 0, 1);
	Mesa_glRotate(projectionMatrix, 90, 0, 0, 1, backEnd.viewDef->projectionMatrix);
	Mesa_glTranslate(backEnd.viewDef->projectionMatrix, 0, -480, 0, backEnd.viewDef->projectionMatrix);
#endif
